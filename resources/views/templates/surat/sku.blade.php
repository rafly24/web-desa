...
<body>
    ...
    <div class="isi-surat">
        ...
        <div class="data-pemohon">
            <table>
                ...
                <tr>
                    <td>Pekerjaan</td>
                    <td>:</td>
                    <td>{{ $pengajuan->pekerjaan ?? 'Wiraswasta' }}</td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>:</td>
        ...
        <p style="text-indent: 40px; margin-top: 20px;">
            Adalah benar warga Desa Karangduren dan memiliki usaha {{ $pengajuan->keperluan }}.
        </p>

        <p style="text-indent: 40px;">
            Surat keterangan ini dibuat untuk keperluan administrasi usaha yang bersangkutan.
        </p>
